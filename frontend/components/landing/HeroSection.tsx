...
import { ArrowRight, ArrowUpRight, Fingerprint, ShieldCheck, Zap, Layers, Search, Lock, ChevronDown } from 'lucide-react';
...
export default function HeroSection({ opacity, yOffset, prefersReducedMotion, login, loginError, setViewMode }: HeroSectionProps) {
    return (
