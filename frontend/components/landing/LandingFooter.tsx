            ...
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-8">
                <div className="col-span-2">
                    ...
                    <div className="flex items-center gap-3">
                        <a href="https://github.com/0xConduit" target="_blank" rel="noreferrer" className="text-white/30 hover:text-white transition-colors">
                        ...
                        <a href="https://x.com/0xconduit" target="_blank" rel="noreferrer" className="text-white/30 hover:text-white transition-colors">
                ...
                <div>
                    ...
                    <ul className="space-y-3 text-sm text-white/35">
                        <li><a href="https://github.com/0xConduit" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">GitHub</a></li>
