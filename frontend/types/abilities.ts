// Mirror of Conduit.sol Ability enum — keep in sync with contracts/conduit/src/Conduit.sol
// 256 abilities: 8 categories x 32 each

export enum Ability {
  // PERCEPTION (0-31)
  PERCEPTION_VISUAL_RECOGNITION = 0,
